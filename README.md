...
- Worked with **GraphRAG, document ingestion, retrieval workflows, and API-based services**.
- Integrated AI components into practical application workflows using **Git/GitHub**.
...
**Recognition:** Top 100 among 1,000+ university projects.
...
- **Top 5% — SQL HackerRank Challenge**
...
- Strengthening **Generative AI, RAG, and GraphRAG systems**
- Improving **ML deployment and software engineering practices**
- Exploring scalable **AI and data products**
...
<p align="center">
  <strong>Data → Intelligence → Applications</strong>
</p>
